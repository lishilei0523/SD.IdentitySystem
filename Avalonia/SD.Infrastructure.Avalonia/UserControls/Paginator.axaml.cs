...
namespace SD.Infrastructure.Avalonia.UserControls
{
    ...
    public partial class Paginator : UserControl
    {
        ...
        /// 页码依赖属性
        /// </summary>
        public static StyledProperty<int> PageIndexProperty;

        /// <summary>
        /// 页容量依赖属性
        /// </summary>
        public static StyledProperty<int> PageSizeProperty;

        /// <summary>
        /// 总记录数依赖属性
        /// </summary>
        public static StyledProperty<int> RowCountProperty;

        /// <summary>
        /// 总页数依赖属性
        /// </summary>
        public static StyledProperty<int> PageCountProperty;

        /// <summary>
        /// 起始行依赖属性
        /// </summary>
        public static StyledProperty<int> StartRowIndexProperty;

        /// <summary>
        /// 终止行依赖属性
        /// </summary>
        public static StyledProperty<int> EndRowIndexProperty;
        ...
        static Paginator()
        {
            ...
            PageSizeProperty.Changed.AddClassHandler<Paginator>(OnPageSizeChanged);
        ...
        /// 页容量改变回调方法
        /// </summary>
        private static void OnPageSizeChanged(Paginator paginator, AvaloniaPropertyChangedEventArgs eventArgs)
        {

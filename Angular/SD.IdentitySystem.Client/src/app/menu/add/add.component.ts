...
import {ApplicationType, ApplicationTypeDescriptor, ComponentBase, NzNode} from "sd-infrastructure";
...
export class AddComponent extends ComponentBase implements OnInit {
     ...
     * 创建菜单创建组件构造器
     * */
    public constructor(modalRef: NzModalRef, messageService: NzMessageService, formBuilder: FormBuilder, menuService: MenuService) {
        super();
